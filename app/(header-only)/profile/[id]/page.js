                    ...
                    <div className="grid grid-cols-3 gap-7">
                        <div>
                            <div className="bg-white">
                                <div
                                    className={clsx('cursor-pointer border-b p-3 font-semibold ', {
                                        'text-primary': typePost === 'posted',
                                    })}
                                    onClick={() => setTypePost('posted')}
                                >
                                    Posted posts
                                </div>
                                <div
                                    className={clsx('cursor-pointer border-b p-3 font-semibold', {
                                        'text-primary': typePost === 'saved',
                                    })}
                                    onClick={() => setTypePost('saved')}
                                >
                                    Saved post
                                </div>
                                <div
                                    className={clsx('cursor-pointer border-b p-3 font-semibold', {
                                        'text-primary': typePost === 'pending',
                                    })}
